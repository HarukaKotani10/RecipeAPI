...
namespace RecipeAPI
{
    public class Seed
    {
        ...
        public void SeedDataContext()
        {
            ...
            {
                new Ingredients { Name = "Flour", Calories = 364, Carbohydrates = 76.3, Protein = 10.3, Fat = 1.2 },
                new Ingredients { Name = "Sugar", Calories = 387, Carbohydrates = 99.5, Protein = 0, Fat = 0 },
                new Ingredients { Name = "Eggs", Calories = 155, Carbohydrates = 1.1, Protein = 12.6, Fat = 10.6 },
                new Ingredients { Name = "Butter", Calories = 717, Carbohydrates = 0.1, Protein = 0.9, Fat = 81.4 },
                new Ingredients { Name = "Milk", Calories = 42, Carbohydrates = 5.2, Protein = 3.4, Fat = 1.0 },
                new Ingredients { Name = "Blueberries", Calories = 57, Carbohydrates = 14.5, Protein = 0.7, Fat = 0.3 }
            };
